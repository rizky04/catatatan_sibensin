                    ...
                    <div class="bg-gas-black text-white p-5 rounded-3xl relative overflow-hidden flex flex-col justify-between h-36 shadow-lg shadow-gray-200">
                        <div class="relative z-10 flex justify-between items-start">
                            ...
                            <div class="flex gap-2">
                                ...
                                <form method="POST" action="{{ route('vehicles.destroy', $vehicle->id) }}" onsubmit="return confirm('Yakin ingin menghapus kendaraan ini? Semua riwayat bensinnya juga akan terhapus.');">
                                    @csrf
                                    @method('DELETE')
