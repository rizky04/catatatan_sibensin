            ...
            <div class="space-y-4">
                @if (!$vehicle)
                    <div class="bg-red-50 border border-red-100 rounded-3xl p-6 text-center shadow-sm">
                        <p class="text-xs font-bold text-red-600">Pilih atau tambahkan kendaraan terlebih dahulu di
                            Garasi.</p>
                    </div>
                @else
                    @forelse ($entries as $entry)
                        <div
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-12 h-12 bg-green-50 rounded-2xl flex items-center justify-center text-gas-green shrink-0">
                                ...
                                <div class="text-right shrink-0">
                                    ...
                                    @if ($entry->kml > 0)
                                        <p
                                            class="text-[9px] font-black text-blue-500 bg-blue-50 inline-block px-2 py-0.5 rounded-full mt-1">
                                            {{ $entry->kml }} KM/L
                                        </p>
                                    @endif
                                </div>
                    ...
                    @empty
                        <div class="bg-gray-50 border-2 border-dashed border-gray-200 rounded-3xl p-8 text-center">
                            ...
                            <p class="text-[10px] font-medium text-gray-400 mt-1">Coba input bensin pertamamu di halaman
                                Home.</p>
                        </div>
                    @endforelse
                @endif
                    ...
                    <form method="POST" :action="editUrl" class="space-y-3">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="bg-gray-50 p-4 rounded-2xl border border-gray-100">
                                <label
                                    class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Tanggal</label>
                                <input type="date" name="date" x-model="date" required
                                    class="w-full bg-transparent font-bold text-sm focus:outline-none py-1 border-none focus:ring-0 text-gas-black">
                            </div>
                            <div class="bg-gray-50 p-4 rounded-2xl border border-gray-100">
                                <label
                                    class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Odometer</label>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div class="bg-gray-50 p-4 rounded-2xl border border-gray-100">
                                ...
                                <select name="fuel_type" x-model="fuel_type"
                                    class="w-full bg-transparent font-bold text-sm focus:outline-none appearance-none border-none focus:ring-0 text-gas-black">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <div class="bg-gray-50 p-3 rounded-2xl border border-gray-100">
                                ...
                                <input type="number" name="price_per_liter" x-model="price" required
                                    class="w-full bg-transparent font-bold text-sm focus:outline-none py-1 border-none focus:ring-0 text-gas-black">
                            </div>
                            <div class="bg-gray-50 p-3 rounded-2xl border border-gray-100">
                            ...
                            <div class="bg-gray-100 p-3 rounded-2xl border border-gray-200">
                                ...
                                <input type="number" name="total_price" :value="total" readonly
                                    class="w-full bg-transparent font-bold text-sm focus:outline-none py-1 border-none focus:ring-0 text-gray-600">
                            </div>
                        </div>
