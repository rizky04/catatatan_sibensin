<x-app-layout>
    ...
    <section id="profil" class="tab-content hidden p-6 space-y-6 text-center">
        ...
        <div class="space-y-2">
            <button class="w-full bg-white p-5 rounded-3xl border border-gray-100 flex items-center justify-between hover:bg-gray-50 transition-colors">
                <span class="font-bold">Pengaturan Kendaraan</span>
